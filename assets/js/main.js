(function () {
  ...
  // Tambahkan setelah kode JavaScript yang sudah ada
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
      ...
      // Mengambil nilai dari masing-masing elemen input
      ...
      // Menampilkan nilai-nilai dalam sebuah alert
      const alertMessage = `Name: ${name}\nEmail: ${email}\nSubject: ${subject}\nMessage: ${message}`;
      alert(alertMessage);

      // Optional: Mengosongkan formulir setelah pengiriman berhasil
      form.reset();
    });
  });
})();
